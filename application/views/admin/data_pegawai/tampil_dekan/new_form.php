        ...
        <div class="box-header">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <a href="<?php echo site_url('admin/TabelDekan') ?>"><i calss="fas fa-arrow-left"></i>Kembali</a>
                </div>
            </div>

            <form action="<?php base_url('admin/TabelDekan/add') ?>" method="post" enctype="multipart/form-data">
                <div class="col-md-12">
